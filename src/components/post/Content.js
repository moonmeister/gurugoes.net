  ...
  return (
    <article className="relative">
      <header className="static text-lg mx-auto w-full">
        <div className="grid w-full" style={{
          ...
          <h1 className="z-10 row-start-2 row-end-3 col-start-2 col-end-3" >
            <span className="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-grey-900 sm:text-4xl">{title}</span>
          </h1>
        </ div>
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="wp-blocks mt-6 prose max-w-prose prose-green prose-lg text-gray-500 mx-auto" dangerouslySetInnerHTML={{ __html: content }} />
      </div>
    </article >
  )
}
